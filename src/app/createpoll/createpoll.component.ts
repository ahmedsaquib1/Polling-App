...
get option4(){
  ...
  onSubmit(){
   ...
   this.createpollservice.getData(this.pollform.value.title,this.pollform.value.option1,this.pollform.value.option2,this.pollform.value.option3,this.pollform.value.option4).subscribe((data:any)=>{
